  ...
  return JSON.stringify(
    {
      ...
      icons: [
        {
          src: "/aw-fighter-192.png",
          sizes: "192x192",
          type: "image/png",
          purpose: "any",
        },
        {
          src: "/aw-fighter-512.png",
          sizes: "512x512",
          type: "image/png",
          purpose: "any",
        },
        {
          src: "/aw-fighter-512-maskable.png",
          sizes: "512x512",
          type: "image/png",
          purpose: "maskable",
        },
        {
          src: "/aw-fighter-180.png",
          sizes: "180x180",
          type: "image/png",
        },
      ],
...
export function grokPwaHeadTags(appName = DEFAULT_APP_NAME) {
  return [
    ...
    ["apple-touch-icon", '<link rel="apple-touch-icon" href="/aw-fighter-180.png">'],
    [
